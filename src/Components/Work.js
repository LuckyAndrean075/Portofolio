...
function Work({ position, company, location, type, duration }) {
  return (
    <article className="pt-8 border-b-2 border-white pb-5 border-opacity-20 dark:border-opacity-20">
      <div className="flex justify-between items-center">
        <h1 className="text-white md:text-lg lg:text-xl">{position}</h1>
        <div className="btn bg-teal-400 text-white text-xs inline-block rounded-3xl px-3 py-1 min-w-fit font-bold">
          {duration}
        </div>
      </div>
      <div className="flex justify-between pt-2">
        <div className="flex flex-col md:flex-row">
          <div className="flex items-center pr-5">
            ...
            <p className="text-white text-xs md:text-sm font-light pl-1">
              {company}
            </p>
          </div>
