...
function Project({
  ...
  return (
    <article className="rounded-xl mt-10 overflow-hidden shadow-xl shadow-slate-300 dark:shadow-slate-900">
      <img className="h-44 w-full" src={image} alt="" loading="lazy" />
      <div className="dark:bg-dark-card p-4 h-full">
        <h1 className="text-white font-semibold text-lg pt-1">{title}</h1>
        <p className="text-white pt-4 font-light text-justify">{description}</p>
        ...
        <div className="flex justify-between items-center mt-5">
          <div className="flex items-center">
            ...
            <a
              ...
              className="underline pl-2 font-light text-teal-400"
            >
              Live Preview
            </a>
          </div>
